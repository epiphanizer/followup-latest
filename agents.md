...
Project version: 3.11.0 (package). Goal: modernize the Angular/Ionic app for Followup v4.
...
- 2026-05-17: Reworked [src/app/modules/user/user-listing/user-listing.component.ts](src/app/modules/user/user-listing/user-listing.component.ts), [src/app/modules/user/user-listing/user-listing.component.html](src/app/modules/user/user-listing/user-listing.component.html), and [src/app/modules/user/user-listing/user-listing.component.scss](src/app/modules/user/user-listing/user-listing.component.scss) into a jumpable duplicate-account workbench with a sticky jump rail, collapsible duplicate groups, clearer merge guidance, and in-page review chips. Updated [src/app/shell/toolbar-nav/toolbar-nav.component.ts](src/app/shell/toolbar-nav/toolbar-nav.component.ts), [src/app/shell/toolbar-nav/toolbar-nav.component.scss](src/app/shell/toolbar-nav/toolbar-nav.component.scss), [src/app/shell/shell.component.ts](src/app/shell/shell.component.ts), and [src/app/shell/shell.component.scss](src/app/shell/shell.component.scss) so Admin can jump directly to Service Health or the Version Change Log, the operations listing is exposed as Clients, and long shell menus no longer clip behind the shell layout. Synced [src/app/shell/service-health-change-log.data.ts](src/app/shell/service-health-change-log.data.ts) with the latest 3.11.0 frontend/API evidence. Validated with focused Jest on [src/app/modules/user/user-listing/user-listing.component.spec.ts](src/app/modules/user/user-listing/user-listing.component.spec.ts), [src/app/shell/toolbar-nav/toolbar-nav.component.spec.ts](src/app/shell/toolbar-nav/toolbar-nav.component.spec.ts), and [src/app/shell/shell.component.spec.ts](src/app/shell/shell.component.spec.ts).
